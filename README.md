...
## Due to changes in JavaFX and the fact that it is no longer packaged with the standard Java runtime environment the program is currently no longer functional. Update coming soon.
